        ...
        <>
            ...
            <div className={styles.container}>
                <div className={styles.vision}>
                    <h2>Our Vision</h2>
                    <p>GrovNest aims to incentivize & tokenization platform for its users to
                         learn more about new digital capabilities and use them in their daily life.
                    </p>
                </div>
                <div className={styles.mission}>
                    <h2>Our Mission</h2>
                    <p>GrovNest's Mission is to become one-an-only paperless & e-platform with real values on each work/task 
